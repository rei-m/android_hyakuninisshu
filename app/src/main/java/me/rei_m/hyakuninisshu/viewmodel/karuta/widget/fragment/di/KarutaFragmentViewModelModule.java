...
@Module
public class KarutaFragmentViewModelModule {

    private final KarutaIdentifier karutaId;

    public KarutaFragmentViewModelModule(@NonNull KarutaIdentifier karutaId) {
        this.karutaId = karutaId;
    }

    @Provides
    @ForFragment
    KarutaFragmentViewModel.Factory provideFactory(@NonNull KarutaStore karutaStore,
                                                   @NonNull KarutaActionDispatcher actionDispatcher) {
        return new KarutaFragmentViewModel.Factory(karutaStore, actionDispatcher, karutaId);
    }
}
