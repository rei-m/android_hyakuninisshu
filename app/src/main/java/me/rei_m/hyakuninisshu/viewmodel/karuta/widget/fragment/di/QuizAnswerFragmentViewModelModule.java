...
public class QuizAnswerFragmentViewModelModule {
    ...
    public QuizAnswerFragmentViewModelModule(@NonNull Karuta karuta, boolean existNextQuiz) {
        this.karuta = karuta;
    ...
    @Provides
    @ForFragment
    QuizAnswerFragmentViewModel.Factory provideFactory() {
        return new QuizAnswerFragmentViewModel.Factory(karuta, existNextQuiz);
    }
}
