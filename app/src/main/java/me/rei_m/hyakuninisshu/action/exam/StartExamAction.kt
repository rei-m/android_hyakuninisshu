...
class StartExamAction private constructor(
    ...
    companion object {
        fun createSuccess(karutaQuizId: KarutaQuizIdentifier) = StartExamAction(karutaQuizId)
        fun createError(error: Throwable) = StartExamAction(null, error)
    }
}
