...
class YomiFudaView @JvmOverloads constructor(
    context: Context,
    ...
    fun startDisplayWithAnimation(yomiFuda: YomiFuda, speed: Long?) {
        ...
        val totalWordList = ArrayList<YomiFudaWordView>().apply {
        ...
        animationDisposable = Observable.interval(speed, TimeUnit.MILLISECONDS)
