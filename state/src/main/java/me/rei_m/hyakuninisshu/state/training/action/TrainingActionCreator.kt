...
class TrainingActionCreator
    ...
    constructor(
         ...
         */
        suspend fun startByExamPractice(): StartTrainingAction =
            try {
         ...
         */
        suspend fun restart(): StartTrainingAction =
            try {
                val targetKarutaNoList =
                    questionRepository
                        .findCollection()
